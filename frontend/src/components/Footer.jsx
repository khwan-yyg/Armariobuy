      ...
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
        <div className="">
          ...
          <p className="w-full md:w-3/2 text-gray-600">
            ...
            numquam, tempore facere veritatis repellendus velit beatae possimus
            placeat laborum. Culpa amet quaerat error quidem, cupiditate dicta
            mollitia voluptatum quam!
          </p>
        </div>
        <div className="">
